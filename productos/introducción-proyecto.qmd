...
En tiempos de pandemia, cuando todo el mundo se encontraba bajo confinamiento para prevenir contagios, para muchas empresas esto significó pérdidas masivas pero una de las pocas que lograron generar ganancias récord fueron los servicios de streaming que, según datos de Motion Picture Association, lograron superar un billón de suscripciones, la cual se transformó como una de las principales fuentes de entretenimiento durante el covid-19.

A raíz de lo anterior, fueron que páginas como IMBD servían como principal fuente de búsqueda de películas o series para pasar nuestro aburrimiento encerrados en la casa, pero primero que todo ¿Qué es IMBD?

IMBD corresponde a una página web principalmente de películas y series, donde la principal característica de esta es poder ver la calificación de estas, donde tanto los críticos profesionales como cualquier persona le pueden dar una nota del 1 al 10 para luego obtener el promedio de las calificaciones. También existen otros apartados como poder ver la trama, el elenco, reseñas de los usuarios y críticos, el equipo de producción y entre otros.

En este proyecto se analizarán las mejores 1000 películas según IMBD, donde algunas variables de interés serán el género, ganancias, año de lanzamiento, número de votos, calificación, entre otros.
...
Las preguntas anteriores tienen el objetivo principal de darnos a entender de mejor forma como han ido variando ciertos elementos de las películas a través de las décadas, ver si existe algún patrón que se mantiene durante el tiempo y obtener interesantes conclusiones a tráves de estas.

Se comenzará con una descripción de las variables a utilizar en el proyecto para ya luego ir resolviendo las preguntas establecidas a través del análisis de gráficos y variables, y así presentar los resultados y conclusiones obtenidas correspondientes. Se finalizará con una conclusión resumiendo a grandes rasgos los resultados obtenidos durante el reporte.
